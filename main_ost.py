...
from all_utils_ost import init, deeplab_v2, train_one_iter, self_train_schedule, test_one_set, load_checkpoint
...
from losses import DynamicLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--threshold', type=float, default=0,
                        help='Online labeling confidence fixed threshold (default: 0)')
    ...
    if args.state == 3:
        ...
        # Self-training
            ...
            labeled_loader, pseudo_labeled_loader, _, val_loader, _ = init(
            ...
            after_loading()
            x = self_train_schedule(writer=writer, labeled_loader=labeled_loader,
